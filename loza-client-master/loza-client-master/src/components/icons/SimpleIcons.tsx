...
export const ShoppingBagIcon = ({ size = 24, className = "" }: { size?: number; className?: string }) => {
  return (
    <svg
      width={size}
      height={size}
...
// Simple Coins Icon
export const CoinsIcon = ({ size = 24, className = "" }: { size?: number; className?: string }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M18.09 10.37A6 6 0 1 1 10.34 4" />
      <path d="M7 6h1v4H7" />
      <path d="M16 14h1v4h-1" />
    </svg>
  );
};
...
// Simple Heart Icon (for Wishlist)
